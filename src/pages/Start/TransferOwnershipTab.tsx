...
import { TransferOwnership } from "@/methods/UpdateState";
import { useWallet } from "@/store";

export const TransferOwnershipTab = () => {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await TransferOwnership(target);
            if (response) {
    ...
    return (
        <div className="p-6 bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center">
            <h1 className="text-4xl font-bold mb-12">Transfer Contract Ownership</h1>
